# deploy_bot.ps1 â€" Deploy VOLKI Telegram Bot to Ubuntu server
...
Write-Host "`nðŸº VOLKI 13:03 â€" Bot Deployment" -ForegroundColor Cyan
...
Write-Host "`nâœ… Bot deployed successfully!" -ForegroundColor Green
